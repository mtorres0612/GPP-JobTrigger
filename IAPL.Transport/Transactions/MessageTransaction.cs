 ...
 *  Change Log:
 * 
 *  MNTORRES 09162016 : Added serialization feature in GetFileList
 * 
 */
using System;
...
namespace IAPL.Transport.Transactions
{
    public class MessageTransaction
    {
        ...
        private void getFileList()
        {
            ...
            db.GetFileTransferInfo(MsgCodeExcluded);
            ...
            //Parallel.ForEach(dTable.AsEnumerable(),
            //                     new ParallelOptions { MaxDegreeOfParallelism = -1 },
            //                     item => Task.Factory.StartNew(() => Process(item))
            //                );

            Worker worker = new Worker();

            worker.Serialize(dTable);
            ...
            if (messageTable.Count > 0)
            {
                    ...
                    messageDetails.ProcessCode.Equals(6))
                {
                    ...
                    IAPL.Transport.Transactions.Worker workerThread = new Worker(threadName,
                                                                                 messageTable.Values.Cast<string>().ToList(),
                                                                                 messageDetails,
                                                                                 sourceServerDetails,
